  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white">گزارش آماری</h1>
          <p className="text-gray-600 dark:text-gray-400 mt-1">نمودارها و آمار کلی از عملکرد سیستم</p>
        </div>
        <div className="flex items-center space-x-4 space-x-reverse">
          <select
            value={period}
            onChange={(e) => setPeriod(e.target.value)}
            className="px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white dark:bg-gray-700 dark:text-white"
          >
      ...
      {loading ? (
        ...
        <div className="bg-red-50 dark:bg-red-900/30 p-6 rounded-lg">
          <div className="flex items-center">
            ...
            <div className="mr-4">
              <h3 className="text-sm font-medium text-red-600 dark:text-red-400">خطا در بارگذاری داده‌ها</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <div className="bg-blue-50 dark:bg-blue-900/30 p-6 rounded-lg">
            <div className="flex items-center">
              ...
              <div className="mr-4">
                <h3 className="text-sm font-medium text-gray-600 dark:text-gray-400">کل کالاها</h3>
          ...
          <div className="bg-red-50 dark:bg-red-900/30 p-6 rounded-lg">
            <div className="flex items-center">
              ...
              <div className="mr-4">
                <h3 className="text-sm font-medium text-gray-600 dark:text-gray-400">موجودی کم</h3>
          ...
          <div className="bg-green-50 dark:bg-green-900/30 p-6 rounded-lg">
            <div className="flex items-center">
              ...
              <div className="mr-4">
                <h3 className="text-sm font-medium text-gray-600 dark:text-gray-400">تراکنش‌های اخیر</h3>
                <p className="text-2xl font-bold text-green-600 dark:text-green-400">{summary?.recentTransactions || 0}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-purple-50 dark:bg-purple-900/30 p-6 rounded-lg">
            <div className="flex items-center">
              ...
              <div className="mr-4">
                <h3 className="text-sm font-medium text-gray-600 dark:text-gray-400">ارزش کل موجودی</h3>
        ...
        <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg text-center">
          <div className="text-gray-500 dark:text-gray-400">
            ...
            <p className="text-lg font-medium">داده‌ای برای نمایش وجود ندارد</p>
            <p className="text-sm">لطفاً دوباره تلاش کنید یا با پشتیبانی تماس بگیرید</p>
          </div>
        </div>
      )}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
          <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">مصرف به تفکیک دسته‌بندی</h3>
            ...
            <div className="space-y-4">
              {categoryData.map((item, index) => (
                <div key={index} className="flex items-center justify-between">
                  ...
                  <div className="flex items-center">
                    <span className="text-sm text-gray-600 dark:text-gray-400 ml-2">{item.value}%</span>
        ...
        {/* Recent Trends */}
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
          <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">روند موجودی اخیر</h3>
          {trendData.length > 0 ? (
      ...
      {/* Monthly Data */}
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
        <h3 className="text-lg font-semibold text-gray-900 dark:text-white mb-4">روند ماهانه ورود و خروج کالا</h3>
        {monthlyData.length > 0 ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
            {monthlyData.slice(-8).map((item, index) => (
              <div key={index} className="p-4 border border-gray-200 dark:border-gray-700 rounded-lg">
                <h4 className="font-medium text-gray-900 dark:text-white mb-2">{item.month}</h4>
      ...
      <div className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-lg p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="bg-white dark:bg-gray-800 rounded-lg p-4">
            <h4 className="font-medium text-gray-900 dark:text-white mb-2">کالاهای کم موجود</h4>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg p-4">
            <h4 className="font-medium text-gray-900 dark:text-white mb-2">تراکنش‌های اخیر</h4>
            <p className="text-sm text-gray-600 dark:text-gray-400 mb-3">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg p-4">
            <h4 className="font-medium text-gray-900 dark:text-white mb-2">گزارش کامل</h4>
            <p className="text-sm text-gray-600 dark:text-gray-400 mb-3">
