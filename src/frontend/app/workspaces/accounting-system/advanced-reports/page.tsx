...
export default function AdvancedReportsPage() {
  ...
  if (error) {
    return (
      <div className="bg-red-100 dark:bg-red-900 text-red-800 dark:text-red-300 p-4 rounded-md m-4">
        {error}
      </div>
    );
  }
    ...
    <div className="space-y-4 sm:space-y-6 p-4 sm:p-6">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-4 sm:p-6">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          ...
          <button className="bg-green-600 text-white px-3 sm:px-4 py-2 rounded-lg hover:bg-green-700 transition-colors text-sm sm:text-base whitespace-nowrap" onClick={openCreateModal}>
            گزارش سفارشی
          </button>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
        {filteredReports.length === 0 ? (
          <div className="col-span-full text-center text-gray-500 dark:text-gray-400 py-8 sm:py-12">
            گزارشی یافت نشد.
          </div>
        ) : filteredReports.map((report) => (
          <div
            key={report.id}
            className={`bg-white dark:bg-gray-800 rounded-lg shadow-sm p-4 sm:p-6 border border-gray-200 dark:border-gray-700 transition-all hover:shadow-md cursor-pointer hover:border-green-300 dark:hover:border-green-600`}
          >
            ...
            <div className="flex flex-wrap items-center justify-between gap-2 mt-3 sm:mt-4">
              <button
                className="bg-gray-500 text-white px-2 sm:px-3 py-1 rounded hover:bg-gray-600 text-xs"
              ...
              <button
                className="bg-green-600 text-white px-2 sm:px-3 py-1 rounded hover:bg-green-700 text-xs"
              ...
              <button
                className="bg-yellow-500 text-white px-2 sm:px-3 py-1 rounded hover:bg-yellow-600 text-xs"
        ...
        <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50 p-4">
          <div className="bg-white dark:bg-gray-800 rounded-lg p-4 sm:p-6 w-full max-w-3xl max-h-[90vh] overflow-y-auto">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-base sm:text-lg font-bold text-gray-900 dark:text-white">نتیجه گزارش: {resultReport?.name}</h2>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-4 sm:p-6">
          <div className="flex items-center">
            ...
            <div className="mr-3 sm:mr-4">
              <p className="text-xs sm:text-sm font-medium text-gray-600 dark:text-gray-400">کل گزارش‌ها</p>
              <p className="text-lg sm:text-xl font-bold text-gray-900 dark:text-white">{reports.length}</p>
            </div>
          </div>
        </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-4 sm:p-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
          <Link
            ...
            className="flex items-center p-3 sm:p-4 border border-gray-200 dark:border-gray-700 rounded-lg hover:border-green-300 dark:hover:border-green-600 transition-colors"
          >
            ...
            <div>
              <h3 className="text-sm sm:text-base font-medium text-gray-900 dark:text-white">تراز آزمایشی</h3>
              <p className="text-xs sm:text-sm text-gray-500 dark:text-gray-400">مانده کلیه حساب‌ها</p>
            </div>
          </Link>
          ...
          >
            ...
            <div>
              <h3 className="text-sm sm:text-base font-medium text-gray-900 dark:text-white">صورت‌های مالی</h3>
              <p className="text-xs sm:text-sm text-gray-500 dark:text-gray-400">ترازنامه و سود و زیان</p>
            </div>
          </Link>
        </div>
      </div>
