      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
          <div className="flex items-center">
            ...
            <div className="mr-4">
              <p className="text-sm font-medium text-gray-600 dark:text-gray-400">تعداد حساب‌ها</p>
              <p className="text-xl font-bold text-gray-900 dark:text-white">{trialBalance?.accounts.length || 0}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
          <div className="flex items-center">
            ...
            <div className="mr-4">
              <p className="text-sm font-medium text-gray-600 dark:text-gray-400">وضعیت تراز</p>
              <p className={`text-xl font-bold ${trialBalance?.isBalanced ? 'text-green-600' : 'text-red-600'}`}>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
          <div className="flex items-center">
            ...
            <div className="mr-4">
              <p className="text-sm font-medium text-gray-600 dark:text-gray-400">اختلاف</p>
