    ...
    <div className="space-y-4 sm:space-y-6 lg:space-y-8">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
        ...
        <div className="flex items-center space-x-3 space-x-reverse bg-white dark:bg-gray-800 rounded-lg p-3 sm:p-4 shadow-sm border border-gray-200 dark:border-gray-700">
          ...
          <div>
            <div className="text-xs sm:text-sm font-medium text-gray-900 dark:text-white">فضای کاری موجودی</div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6">
        {loading ? (
          ...
          Array.from({ length: 4 }).map((_, i) => (
            <div key={i} className="card flex items-center p-3 sm:p-6 animate-pulse">
              <div className="p-2 sm:p-3 rounded-lg bg-gray-200 dark:bg-gray-700 w-8 h-8 sm:w-12 sm:h-12 ml-3 sm:ml-4"></div>
              <div className="flex-1">
                <div className="h-3 sm:h-4 bg-gray-200 dark:bg-gray-700 rounded mb-2"></div>
                <div className="h-4 sm:h-6 bg-gray-200 dark:bg-gray-700 rounded"></div>
              </div>
            </div>
          ))
        ) : stats ? (
          [
            ...
            <div key={stat.id} className="card flex items-center p-3 sm:p-6 hover:shadow-lg transition-shadow">
              <div className={`p-2 sm:p-3 rounded-lg ${stat.color} ml-3 sm:ml-4`}>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-3 sm:p-6">
        <h2 className="text-lg sm:text-xl font-bold mb-4 sm:mb-6 text-gray-900 dark:text-white">عملیات سریع</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6">
          {/* Add Inventory Entry (IN) */}
          <Link
            href="/workspaces/inventory-management/inventory/add"
            className="group p-3 sm:p-4 border border-gray-200 dark:border-gray-700 rounded-lg hover:border-green-300 dark:hover:border-green-600 hover:shadow-md transition-all duration-200"
          >
            <div className="flex items-center space-x-2 sm:space-x-3 space-x-reverse">
              <div className="w-8 h-8 sm:w-12 sm:h-12 bg-green-100 dark:bg-green-900/20 rounded-lg flex items-center justify-center group-hover:bg-green-200 dark:group-hover:bg-green-800/30 transition-colors">
              ...
              <div className="flex-1">
                <h3 className="text-sm sm:text-base font-medium text-gray-900 dark:text-white group-hover:text-green-600 dark:group-hover:text-green-400 transition-colors">
                  ثبت ورود کالا
                </h3>
          ...
          <Link
            ...
            className="group p-3 sm:p-4 border border-gray-200 dark:border-gray-700 rounded-lg hover:border-red-300 dark:hover:border-red-600 hover:shadow-md transition-all duration-200"
          >
            <div className="flex items-center space-x-2 sm:space-x-3 space-x-reverse">
              <div className="w-8 h-8 sm:w-12 sm:h-12 bg-red-100 dark:bg-red-900/20 rounded-lg flex items-center justify-center group-hover:bg-red-200 dark:group-hover:bg-red-800/30 transition-colors">
              ...
              <div className="flex-1">
                <h3 className="text-sm sm:text-base font-medium text-gray-900 dark:text-white group-hover:text-red-600 dark:group-hover:text-red-400 transition-colors">
                  ثبت خروج کالا
                </h3>
                <p className="text-xs text-gray-500 dark:text-gray-400">
                  کاهش موجودی
          ...
          <Link
            ...
            className="group p-3 sm:p-4 border border-gray-200 dark:border-gray-700 rounded-lg hover:border-blue-300 dark:hover:border-blue-600 hover:shadow-md transition-all duration-200"
          >
            <div className="flex items-center space-x-2 sm:space-x-3 space-x-reverse">
              <div className="w-8 h-8 sm:w-12 sm:h-12 bg-blue-100 dark:bg-blue-900/20 rounded-lg flex items-center justify-center group-hover:bg-blue-200 dark:group-hover:bg-blue-800/30 transition-colors">
                <svg className="w-4 h-4 sm:w-6 sm:h-6 text-blue-600 dark:text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" />
                </svg>
              </div>
              <div className="flex-1">
                <h3 className="text-sm sm:text-base font-medium text-gray-900 dark:text-white group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">
                  افزودن کالای جدید
                </h3>
                <p className="text-xs text-gray-500 dark:text-gray-400">
                  تعریف کالای جدید
          ...
          <Link
            ...
            className="group p-3 sm:p-4 border border-gray-200 dark:border-gray-700 rounded-lg hover:border-purple-300 dark:hover:border-purple-600 hover:shadow-md transition-all duration-200"
          >
            <div className="flex items-center space-x-2 sm:space-x-3 space-x-reverse">
              <div className="w-8 h-8 sm:w-12 sm:h-12 bg-purple-100 dark:bg-purple-900/20 rounded-lg flex items-center justify-center group-hover:bg-purple-200 dark:group-hover:bg-purple-800/30 transition-colors">
              ...
              <div className="flex-1">
                <h3 className="text-sm sm:text-base font-medium text-gray-900 dark:text-white group-hover:text-purple-600 dark:group-hover:text-purple-400 transition-colors">
                  اسکن بارکد
                </h3>
                <p className="text-xs text-gray-500 dark:text-gray-400">
                  اسکن و عملیات سریع
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
        ...
        <div className="lg:col-span-2">
          <h2 className="text-lg sm:text-xl font-bold mb-4 sm:mb-6 text-gray-900 dark:text-white">فعالیت‌های اخیر</h2>
          <div className="card">
            {loading ? (
              <div className="divide-y divide-gray-200 dark:divide-gray-700">
                {Array.from({ length: 4 }).map((_, i) => (
                  <div key={i} className="py-3 sm:py-4 first:pt-0 last:pb-0 animate-pulse">
                    <div className="flex justify-between mb-2">
                      <div className="h-3 sm:h-4 bg-gray-200 dark:bg-gray-700 rounded w-1/2"></div>
                      <div className="h-3 bg-gray-200 dark:bg-gray-700 rounded w-12 sm:w-16"></div>
                    </div>
              ...
              <div className="divide-y divide-gray-200 dark:divide-gray-700">
                {recentActivities.map((activity) => (
                  <div key={activity.id} className="py-3 sm:py-4 first:pt-0 last:pb-0">
              ...
              <div className="text-center py-6 sm:py-8 text-gray-500 dark:text-gray-400">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 sm:h-12 sm:w-12 mx-auto mb-4 opacity-50" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5H7a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" />
                </svg>
                <p className="text-sm sm:text-base">هنوز تراکنشی ثبت نشده است</p>
              </div>
            )}
            
            {recentActivities.length > 0 && (
              <div className="mt-4 sm:mt-6 text-center">
                <Link href="/workspaces/inventory-management/inventory" className="text-primary-500 hover:text-primary-600 text-xs sm:text-sm font-medium">
         ...
         {loading ? (
               ...
               <div key={i} className="flex items-center justify-between p-2 sm:p-3 bg-gray-50 dark:bg-gray-700 rounded-lg animate-pulse">
                 <div className="flex items-center space-x-2 sm:space-x-3 space-x-reverse">
                   ...
                   <div>
                     ...
                     <div className="h-3 bg-gray-200 dark:bg-gray-600 rounded w-12 sm:w-16"></div>
                   </div>
                 </div>
           ...
           <div className="space-y-2 sm:space-y-3">
             {stats && Array.from({ length: Math.min(5, stats.totalItems) }).map((_, i) => (
               <div key={i} className="flex items-center justify-between p-2 sm:p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                 <div className="flex items-center space-x-2 sm:space-x-3 space-x-reverse">
