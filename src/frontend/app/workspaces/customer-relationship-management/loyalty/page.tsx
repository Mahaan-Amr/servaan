  ...
  return (
    <div className="space-y-4 sm:space-y-6 p-4 sm:p-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          <h1 className="text-xl sm:text-3xl font-bold text-gray-900 dark:text-white">برنامه وفاداری</h1>
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          <button
            ...
            className="inline-flex items-center justify-center px-3 py-2 sm:px-4 sm:py-2 bg-green-600 hover:bg-green-700 text-white text-xs sm:text-sm font-medium rounded-lg transition-colors"
          >
          ...
          <button
            ...
            className="inline-flex items-center justify-center px-3 py-2 sm:px-4 sm:py-2 bg-red-600 hover:bg-red-700 text-white text-xs sm:text-sm font-medium rounded-lg transition-colors"
          >
            <svg className="w-4 h-4 sm:w-5 sm:h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="border-b border-gray-200 dark:border-gray-700">
        <nav className="-mb-px flex overflow-x-auto space-x-4 sm:space-x-8 space-x-reverse">
          {[
            ...
            >
              <svg className={`ml-2 -mr-0.5 h-4 w-4 sm:h-5 sm:w-5 ${
      ...
      {activeTab === 'overview' && statistics && (
        <div className="space-y-4 sm:space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-4 sm:p-6">
              <div className="flex items-center">
                ...
                <div className="mr-3 sm:mr-4">
                  <p className="text-xs sm:text-sm font-medium text-gray-600 dark:text-gray-400">کل امتیازات صادر شده</p>
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-4 sm:p-6">
              <div className="flex items-center">
                ...
                <div className="mr-3 sm:mr-4">
                  <p className="text-xs sm:text-sm font-medium text-gray-600 dark:text-gray-400">کل امتیازات استفاده شده</p>
                  <p className="text-lg sm:text-2xl font-bold text-gray-900 dark:text-white">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-4 sm:p-6">
              <div className="flex items-center">
                ...
                <div className="mr-3 sm:mr-4">
                  <p className="text-xs sm:text-sm font-medium text-gray-600 dark:text-gray-400">میانگین امتیاز هر مشتری</p>
                  <p className="text-lg sm:text-2xl font-bold text-gray-900 dark:text-white">
          ...
          {statistics.topLoyaltyCustomers && statistics.topLoyaltyCustomers.length > 0 && (
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-4 sm:p-6">
              <h3 className="text-base sm:text-lg font-medium text-gray-900 dark:text-white mb-3 sm:mb-4">برترین مشتریان وفادار</h3>
              <div className="space-y-3 sm:space-y-4">
                {statistics.topLoyaltyCustomers.slice(0, 5).map((customer, index) => (
                  <div key={customer.id} className="flex flex-col sm:flex-row sm:items-center sm:justify-between p-3 sm:p-4 bg-gray-50 dark:bg-gray-700 rounded-lg gap-2 sm:gap-0">
                    <div className="flex items-center">
                      ...
                      <div className="mr-3">
                        ...
                        <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400" dir="ltr">{customer.phone}</p>
                      </div>
                    </div>
                ...
                <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                  {transactions.map((transaction) => (
                    <tr key={transaction.id} className="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                      ...
                      <td className="px-3 sm:px-6 py-4 whitespace-nowrap">
                        <span className={`text-xs sm:text-sm font-medium ${getTransactionTypeColor(transaction.transactionType)}`}>
      ...
      {activeTab === 'manage' && (
        <div className="space-y-4 sm:space-y-6">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-4 sm:p-6">
            <h3 className="text-base sm:text-lg font-medium text-gray-900 dark:text-white mb-3 sm:mb-4">اعمال سریع</h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              <button
                onClick={() => setShowAddPointsModal(true)}
                className="p-4 sm:p-6 text-center border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg hover:border-green-500 hover:bg-green-50 dark:hover:bg-green-900/20 transition-colors"
              >
                <svg className="w-6 h-6 sm:w-8 sm:h-8 mx-auto text-green-600 mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
                </svg>
                <p className="text-xs sm:text-sm font-medium text-gray-900 dark:text-white">افزودن امتیاز</p>
                <p className="text-xs text-gray-500 dark:text-gray-400">اعطای امتیاز دستی به مشتری</p>
              </button>

              <button
                onClick={() => setShowRedeemPointsModal(true)}
                className="p-4 sm:p-6 text-center border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg hover:border-red-500 hover:bg-red-50 dark:hover:bg-red-900/20 transition-colors"
              >
                <svg className="w-6 h-6 sm:w-8 sm:h-8 mx-auto text-red-600 mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M20 12H4" />
                </svg>
                <p className="text-xs sm:text-sm font-medium text-gray-900 dark:text-white">استفاده امتیاز</p>
              ...
              <Link
                ...
                className="p-4 sm:p-6 text-center border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg hover:border-blue-500 hover:bg-blue-50 dark:hover:bg-blue-900/20 transition-colors"
              >
                <svg className="w-6 h-6 sm:w-8 sm:h-8 mx-auto text-blue-600 mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                </svg>
                <p className="text-xs sm:text-sm font-medium text-gray-900 dark:text-white">مدیریت مشتریان</p>
          ...
          {/* Tier Information */}
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-4 sm:p-6">
            <h3 className="text-base sm:text-lg font-medium text-gray-900 dark:text-white mb-3 sm:mb-4">سطوح وفاداری</h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              {[
                ...
                <div key={tier.tier} className="border border-gray-200 dark:border-gray-600 rounded-lg p-3 sm:p-4">
                  <div className={`w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br ${tier.color} rounded-lg flex items-center justify-center mb-3`}>
                    <svg className="w-5 h-5 sm:w-6 sm:h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z" />
                    </svg>
                  </div>
                  <h4 className="text-sm sm:text-base font-medium text-gray-900 dark:text-white mb-2">{tier.label}</h4>
      ...
      {showAddPointsModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white dark:bg-gray-800 rounded-lg p-4 sm:p-6 w-full max-w-md">
            <h3 className="text-base sm:text-lg font-medium text-gray-900 dark:text-white mb-3 sm:mb-4">افزودن امتیاز</h3>
            <form onSubmit={handleAddPoints} className="space-y-3 sm:space-y-4">
              ...
              <div className="flex flex-col sm:flex-row justify-end gap-3">
                <button
                  ...
                  className="px-3 py-2 sm:px-4 sm:py-2 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 text-xs sm:text-sm rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700"
                >
                  انصراف
                </button>
                <button
                  type="submit"
                  className="px-3 py-2 sm:px-4 sm:py-2 bg-green-600 hover:bg-green-700 text-white text-xs sm:text-sm rounded-lg"
                >
                  افزودن امتیاز
                </button>
              </div>
      ...
      {showRedeemPointsModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white dark:bg-gray-800 rounded-lg p-4 sm:p-6 w-full max-w-md">
            <h3 className="text-base sm:text-lg font-medium text-gray-900 dark:text-white mb-3 sm:mb-4">استفاده از امتیاز</h3>
            <form onSubmit={handleRedeemPoints} className="space-y-3 sm:space-y-4">
              <div>
                <label className="block text-xs sm:text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                  مشتری
                </label>
              ...
              <div className="flex flex-col sm:flex-row justify-end gap-3">
                ...
                <button
                  type="submit"
                  className="px-3 py-2 sm:px-4 sm:py-2 bg-red-600 hover:bg-red-700 text-white text-xs sm:text-sm rounded-lg"
                >
                  استفاده امتیاز
                </button>
              </div>
