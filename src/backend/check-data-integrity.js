...
async function checkDataIntegrity() {
  ...
  try {
    ...
    console.log('Sample suppliers:', suppliers.map(s => ({ id: s.id, name: s.name, contactEmail: s.contactEmail })));
    console.log('');
    ...
    console.log('Sample inventory transactions:', inventory.map(i => ({
      id: i.id,
      type: i.type,
      quantity: i.quantity,
    ...
    console.log('Sample journal entries:', journalEntries.map(j => ({
      id: j.id,
